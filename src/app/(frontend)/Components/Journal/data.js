...
export const articles = [
  {
    ...
    points: [
      { heading: 'Lighten Your Colour Palette', description: 'Introduce soft neutral shades inspired by nature.' },
      { heading: 'Add Natural Textures', description: 'Combine linen, wood and marble for warmth.' },
      { heading: 'Refresh Your Seating', description: 'Invest in comfortable statement seating.' },
      { heading: 'Style with Accessories', description: 'Update vases, candles and decorative objects.' },
      ...
      { heading: 'Declutter', description: 'Open, organised spaces feel cooler and more luxurious.' },
      { heading: 'Introduce Organic Shapes', description: 'Curved furniture softens interiors.' },
      { heading: 'Invest in Timeless Pieces', description: 'Choose quality furniture that lasts beyond trends.' },
    ],
  },
  {
    ...
    points: [
      { heading: 'Choose the Right Spot', description: 'Look for unused corners near natural light or windows.' },
      { heading: 'Invest in Comfortable Seating', description: 'A luxurious accent chair instantly defines the space.' },
      { heading: 'Layer Soft Textures', description: 'Use cushions, throws and rugs to create warmth.' },
      { heading: 'Add Functional Furniture', description: 'A side table keeps books, drinks and décor within reach.' },
      { heading: 'Style with Lighting', description: 'A table or floor lamp creates a relaxing ambience.' },
      { heading: 'Personalise the Space', description: 'Include books, candles, artwork and greenery that reflect your personality.' },
    ],
  },
  {
    ...
    points: [
      { heading: 'Start with Soft Neutrals', description: 'Use beige, ivory and sand as the foundation.' },
      {
        heading: 'Introduce Seasonal Accent Colours',
        description: 'Terracotta, olive, sage, muted blue and warm coral create a fresh summer palette.',
      },
      {
      ...
      },
      {
        ...
        description: 'A coloured accent chair or ottoman adds personality without overwhelming the space.',
      },
    ],
  },
]
